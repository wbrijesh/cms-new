...
export default function Content({
  ...
  const [revenueTypesObject, setRevenueTypesObject] = useState([]);

  if (revenueTypesObject.includes(thisCampaign.video_revType)) {
    console.log("Revenue type ignored");
  } else {
    revenueTypesObject.push(thisCampaign.video_revType);
  }

  if (revenueTypesObject.includes(thisCampaign.display_revType)) {
    console.log("Revenue type ignored");
  } else {
    revenueTypesObject.push(thisCampaign.display_revType);
  }

  if (revenueTypesObject.includes(thisCampaign.native_revType)) {
    console.log("Revenue type ignored");
  } else {
    revenueTypesObject.push(thisCampaign.native_revType);
  }

  if (revenueTypesObject.includes(thisCampaign.search_revType)) {
    console.log("Revenue type ignored");
  } else {
    revenueTypesObject.push(thisCampaign.search_revType);
  }

  if (revenueTypesObject.includes(thisCampaign.social_revType)) {
    console.log("Revenue type ignored");
  } else {
    revenueTypesObject.push(thisCampaign.social_revType);
  }

  if (revenueTypesObject.includes(thisCampaign.highImpact_revType)) {
    console.log("Revenue type ignored");
  } else {
    revenueTypesObject.push(thisCampaign.highImpact_revType);
  }

  if (revenueTypesObject.includes(thisCampaign.richMedia_revType)) {
    console.log("Revenue type ignored");
  } else {
    revenueTypesObject.push(thisCampaign.richMedia_revType);
  }

  if (revenueTypesObject.includes(thisCampaign.pop_revType)) {
    console.log("Revenue type ignored");
  } else {
    revenueTypesObject.push(thisCampaign.pop_revType);
  }

  if (revenueTypesObject.includes(thisCampaign.push_revType)) {
    console.log("Revenue type ignored");
  } else {
  ...
  // const verifyAccess = () => {
  //   console.log("Payload: ", user.signInUserSession.accessToken.payload);
  // };
                          ...
                          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div className="mt-2">
                              <p className="text-sm text-gray-500">
                                ...
                                All of your data and associated campaigns will
                        ...
                        <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                          ...
                          <dl className="divide-y divide-gray-200">
                            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                              ...
                              {/* <p>{revenueTypesObject.toString()}</p> */}
                              <dd className="mt-1 flex text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <span className="flex-grow">
                                  {revenueTypesObject.map((revType) => {
                                    if (revType !== undefined) {
                                      return (
