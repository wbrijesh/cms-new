...
export default function Content({
  ...
  campaignList && console.log("CAMPAIGN LIST:", campaignList);
        ...
        userDetails && (
          <div className="flex-1 flex flex-col">
            <div className="w-full max-w-4xl bg-red-400 mx-auto md:px-8 xl:px-0 sm:invisible">
              <div className="relative z-10 flex-shrink-0 h-16 sm:h-0 bg-white border-b border-gray-100 md:border-white flex">
                <button
